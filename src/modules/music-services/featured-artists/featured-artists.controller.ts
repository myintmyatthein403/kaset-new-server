...
@Controller('featured-artists')
export class FeaturedArtistsController {
  constructor(
    private readonly baseService: FeaturedArtistsService
  ) { }
  ...
  async update(
    ...
    return this.baseService.updateFeaturedArtist(id, data);
  }
