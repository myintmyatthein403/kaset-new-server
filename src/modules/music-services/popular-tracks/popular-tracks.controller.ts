...
@Controller('popular-tracks')
export class PopularTracksController {
  constructor(
    private readonly baseService: PopularTracksService
  ) { }
  ...
  async update(
    ...
    return this.baseService.updatePopularTracks(id, data);
  }
