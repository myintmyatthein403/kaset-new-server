...
export class CollectionsController {
  constructor(
    private readonly baseService: CollectionsService
  ) { }
  ...
  @UseGuards(JwtOrApiKeyGuard)
  @Get('/slug/:slug')
  async findTrackBySlug(@Param('slug') slug: string) {
    return this.baseService.findWithSlug(slug);
  }
  ...
  async update(
    ...
    return this.baseService.updateCollection(id, data);
  }
